...
function initDb() {
  db.exec(`
    ...
    /*
     * Bolt Optimization: Add SQLite B-tree indexes for all project_id, user_id,
     * task_id, bucket_id, and record_id foreign key query filters.
     * Replaces O(N) full table scans with O(log N) index lookups across all API endpoints.
     */
    ...
    CREATE INDEX IF NOT EXISTS idx_attendance_project_user ON attendance(project_id, user_id);
    ...
    CREATE INDEX IF NOT EXISTS idx_plan_tasks_project_bucket ON plan_tasks(project_id, bucket_id);
